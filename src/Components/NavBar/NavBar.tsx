...
const NavBar = () => {
  ...
  return (
    <header  aria-label="Main navigation">
      <nav className={`font-semibold text-[18px]  navbar ${scrolled ? "scrolled" : ""}`} aria-label="Site navigation">
        <div className="flex flex-wrap items-center justify-between py-4 w-[85%] mx-auto">
          <div className="flex items-center gap-2">
            <h1 className="text-4xl font-bold text-shadow-lg text-shadow-teal-800 text-[var(--light-color)]" aria-label="Site logo">
              HS.
            </h1>
          </div>
